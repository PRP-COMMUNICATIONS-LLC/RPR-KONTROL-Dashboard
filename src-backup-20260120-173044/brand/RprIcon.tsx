...
/**
 * RPR Shield Icon Component
 * Geometric triangle logo representing RPR Communications
 */
export const RprIcon: React.FC<RprIconProps> = ({
  size = 32,
  className = '',
  fill,
  color = 'currentColor'
